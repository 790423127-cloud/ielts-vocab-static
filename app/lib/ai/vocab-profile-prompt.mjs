...
export function buildAiWordProfilePrompt(inputItems) {
  ...
  return [
    ...
    "7. Return 0-4 reliable synonyms that can replace the headword in its primary sense. Use an empty array when no safe replacement exists; never add merely related words.",
