...
export function pickWordSnapshot(word) {
  ...
  return {
    ...
    meaningDetailZh: word.meaningDetailZh || "",
    definition: word.definition || "",
    otherMeanings: word.otherMeanings || [],
    ...
    aiContentProfile: word.aiContentProfile || "",
    aiWrongRepairedAt: word.aiWrongRepairedAt || "",
...
export function summarizeWordChanges(beforeWord, afterWord) {
  const fields = [
    ...
    ["topics", "主题"],
    ["difficulty", "难度"],
    ["aiContentProfile", "AI内容版本"],
    ["aiWrongRepairedAt", "AI修复时间"],
    ["reviewCount", "复习次数"],
    ["correctCount", "正确次数"],
    ["wrongCount", "错误次数"],
    ["mastery", "掌握度"],
