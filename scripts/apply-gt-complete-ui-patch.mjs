...
const insertWithSourceLineEndings = INSERT.replace(/\n/g, lineEnding);
fs.writeFileSync(
  TARGET,
  source.replace(ANCHOR_PATTERN, (anchor) => `${insertWithSourceLineEndings}${anchor}`),
  "utf8"
);
